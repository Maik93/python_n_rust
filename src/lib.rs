...
#[pyfunction] // Add this decorator to each function that you want to make available in Python
fn guess_the_number() {
    ...
    loop {
        ...
        let guess: u32 = match guess.trim().parse() {
            Ok(num) => num,
            Err(_) => {
                print!("It does not seem that you wrote an integer!");
                continue;
            }
        };
        ...
        match guess.cmp(&secret_number) {
            ...
            Ordering::Equal => {
                println!("EXACT! How did you know?");
                break;
            }
        }
    }
